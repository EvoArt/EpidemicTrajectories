...
chn, elapsed = run_badger_fit(5000; n_burn=0, seed=13)
report(chn)
save_run(chn, elapsed, 5000; tag="5000iter")
println("5000-sweep timing: ", round(elapsed, digits=1), " s (",
        round(elapsed / 60, digits=2), " min); ",
        round(elapsed / 5000, digits=3), " s/sweep")
